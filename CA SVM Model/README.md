...
Here you will find several sample files of the work I conducted while working for the California Department of Housing for the final SVM. Since most of the files generated were too large for GitHub, the files you will find here were created generated for this portfolio. However, I was able to include some of the original work. The datasets were much too large to include, but it is possible to load a sample SVM on your device.

## CAML and XL
Above you will see slightly edited (so that you may test the portfolio) Python files made to train or load an SVM. Additionally, sample Excel functions are under 'XLFunctions'.
...
This file contains model parameters that were saved using the joblib Python library. I was able to include one of our actual SVM test parameters.
