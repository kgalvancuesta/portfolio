...
To load an SVM, the Python paths must be edited to match the location of the .SAV file. To train an SVM on your own dataset, the command can be run in Anaconda as follows:  

> **python CAML_LOAD_SAV.py --k [kernel type] --c [value for C] --g [value for Gamma]**
